...
export const metadata: Metadata = { title: "RetainIQ â€” Retention client IA, anticipez le churn avant qu'il arrive", description: "Detectez les clients a risque en temps reel. -45% churn, +2.1x LTV. RetainIQ declenche les actions de retention automatiquement." };
